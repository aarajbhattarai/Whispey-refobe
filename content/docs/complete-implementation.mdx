...
description: Full LiveKit integration example with Refobe
---
...
# Initialize Refobe with your Agent ID from the dashboard
...
async def entrypoint(ctx: agents.JobContext):
    ...
    print(f"Refobe Analytics started for session: {session_id}")
