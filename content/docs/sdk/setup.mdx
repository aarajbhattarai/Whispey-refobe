---
title: SDK Setup
description: Install and configure the Refobe SDK
---

## Installation

Install the Refobe SDK using pip:

```bash
pip install whispey
```

Or install from [PyPI](https://pypi.org/project/Refobe/):
