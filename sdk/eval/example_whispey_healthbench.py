#!/usr/bin/env python3
"""
Example: Using HealthBench Evaluation with Refobe

This example demonstrates how to use the HealthBench evaluation feature
integrated into the Refobe SDK.
...
async def example_healthbench_evaluation():
    """
    Example showing how to use HealthBench evaluation with Refobe
    """
    ...
    print("🚀 HealthBench Evaluation with Refobe Example")
    print("=" * 50)
    
    # Initialize Refobe with your agent configuration
    ...
    print(f"\n📤 Session data ready to send to Refobe API")
    print(f"Session ID: {session_id}")
    
    # In a real application, you would send this to Refobe:
...
if __name__ == "__main__":
    ...
    # Run the Refobe integration example
    ...
    print("4. Results will be included in the metadata sent to Refobe")
