...
"""Refobe Observe SDK - Voice Analytics for AI Agents"""

__version__ = "2.1.1"
__author__ = "Refobe AI Voice Analytics"
...
class LivekitObserve:
    ...
    def _setup_telemetry(self, session_id):
        ...
        class RefobeSpanCollector(SpanProcessor):
        ...
        tracer_provider.add_span_processor(RefobeSpanCollector(self))
