        ...
        <div className="space-y-8">
          ...
          <div className="bg-white rounded-xl border border-gray-300 shadow-sm hover:shadow-md transition-all duration-300">
            ...
            <div className="p-6 space-y-4 text-gray-700 leading-relaxed">
              <p>
                At Refobe (developed by Singularity Corp Pvt Ltd - Pype AI), we believe in transparency 
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-gray-600 mb-2">
                    We work with trusted third-party services to operate Refobe:
                  </p>
          ...
          <div className="bg-white rounded-xl border border-gray-300 shadow-sm hover:shadow-md transition-all duration-300">
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <p className="text-sm text-blue-900">
                  <strong>Exercise Your Rights:</strong> Contact us at hello@refobe.com to exercise any of these 
          ...
          <div className="bg-white rounded-xl border border-gray-300 shadow-sm hover:shadow-md transition-all duration-300">
            ...
            <div className="p-6 space-y-4 text-gray-700">
              <p>
                ...
                When you use Refobe, your data may be transferred to and processed in countries 
                other than your own.
              </p>
              <p className="text-sm">
          ...
          <div className="bg-white rounded-xl border border-gray-300 shadow-sm hover:shadow-md transition-all duration-300">
            ...
            <div className="p-6 space-y-4 text-gray-700">
              <p>
                Refobe is not intended for use by children under 18 years of age. We do not knowingly 
          ...
          <div className="bg-white rounded-xl border border-gray-300 shadow-sm hover:shadow-md transition-all duration-300">
            ...
            <div className="p-6 space-y-4 text-gray-700">
              ...
              <ul className="space-y-1 text-sm ml-4">
                ...
                <li>• Prominent notice in the Refobe dashboard</li>
                <li>• Update to the "Last Updated" date at the top of this policy</li>
              </ul>
              <p className="text-sm">
                Continued use of Refobe after changes means you accept the updated policy.
              </p>
            </div>
          </div>
