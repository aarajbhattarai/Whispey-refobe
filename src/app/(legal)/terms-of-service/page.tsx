          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-600 mt-2">
                Please read these terms carefully before using Refobe's hosted service
              </p>
          ...
          <div className="bg-white rounded-xl border border-gray-300 shadow-sm hover:shadow-md transition-all duration-300">
            <div className="p-6 border-b border-gray-200">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-xl font-semibold text-gray-900">Welcome to Refobe</h2>
              </div>
            </div>
            <div className="p-6 space-y-4 text-gray-700 leading-relaxed">
              <p>
                These Terms of Service ("Terms") govern your use of Refobe's hosted voice AI agents 
                observability platform ("Service"). Refobe helps you monitor, analyze, and optimize 
              ...
              <p>
                Refobe is developed by Pype AI (Singularity Corp Pvt Ltd, India) and is available as 
                open-source software. This hosted version is provided for convenience and testing. 
                You can self-host Refobe at no cost using your existing Vercel and Supabase accounts.
          ...
          <div className="bg-white rounded-xl border border-gray-300 shadow-sm hover:shadow-md transition-all duration-300">
            ...
            <div className="p-6 space-y-4">
              <p className="text-gray-700 mb-4">
                You agree to use Refobe only for lawful purposes and in accordance with these Terms. 
            ...
            <div className="p-6 space-y-4">
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    When using Refobe to manage phone calling campaigns, you are responsible for 
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Refobe provides cost analytics for your voice AI operations, breaking down costs 
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Refobe analyzes each step in your LiveKit pipeline to help identify optimization 
            ...
            <div className="p-6 space-y-4">
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    When self-hosting Refobe, you have complete control over your data. The open-source version 
